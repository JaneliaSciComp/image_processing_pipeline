                ...
                render(data, type, row, meta) {
                    ...
                    if (data && data.constructor === Array) {
                        for (var i = 0; i < data.length; i++) {
                            jacsLinks = jacsLinks + "<a href=\"" + jacs_dashboard_url + "/job/" + data[i] + "\" target=\"_blank\">" + data[i] + "</a>,";
                        }
                        jacsLinks = jacsLinks.slice(0, -1);
                    }
                    else {
                        jacsLinks = jacsLinks + "<a href=\"" + jacs_dashboard_url + "/job/" + data + "\" target=\"_blank\">" + data + "</a>";
                    }
                    return jacsLinks;
                }
            }
